...
our %return_counts = (
        ...
        'get_entity_PhenotypeDescription' => 1,
        'query_entity_PhenotypeDescription' => 1,
        'all_entities_PhenotypeDescription' => 1,
        'get_entity_PhenotypeExperiment' => 1,
        'query_entity_PhenotypeExperiment' => 1,
        'all_entities_PhenotypeExperiment' => 1,
        ...
        'get_relationship_HasAssociatedMeasurement' => 1,
        'get_relationship_MeasuresPhenotype' => 1,
        ...
        'get_relationship_UsedBy' => 1,
        'get_relationship_UsesMedia' => 1,
        'get_relationship_UsedInExperimentalUnit' => 1,
