...
our %return_counts = (
        ...
        'get_relationship_HasVariant' => 1,
        'get_relationship_IsVariantOf' => 1,
        'get_relationship_HasVariation' => 1,
        'get_relationship_IsLocatedOn' => 1,
        ...
        'get_relationship_ResultsIn' => 1,
        'get_relationship_WasDetermiedBy' => 1,
        ...
        'get_relationship_SummarizedBy' => 1,
