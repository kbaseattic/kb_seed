...
item. Each item sent back by the result handle is a 2-tuple containing an
incoming contig ID and a reference to a list of hit regions. Each hit
...
Genome Set (OTU) from which the gene is likely to have originated.
