...
=head1 svr_delete_from_set

Delete entries from a persistent set owned by owner
...
would read a 1-column table of entries and delete them from the contents of the set named set_name owned by owner.
------
...
PersistentSets::delete_from_set($set_name, $owner, \@entries);
