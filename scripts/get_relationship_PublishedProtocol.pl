...
get_relationship_PublishedProtocol [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_PublishedProtocol [arguments] < ids > table.with.fields.added
