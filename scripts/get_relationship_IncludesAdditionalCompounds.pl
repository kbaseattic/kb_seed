...
get_relationship_IncludesAdditionalCompounds [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IncludesAdditionalCompounds [arguments] < ids > table.with.fields.added
