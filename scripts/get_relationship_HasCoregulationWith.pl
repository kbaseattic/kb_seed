...
get_relationship_HasCoregulationWith [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasCoregulationWith [arguments] < ids > table.with.fields.added
