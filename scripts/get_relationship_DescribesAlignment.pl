...
get_relationship_DescribesAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_DescribesAlignment [arguments] < ids > table.with.fields.added
