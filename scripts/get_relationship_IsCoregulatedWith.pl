...
get_relationship_IsCoregulatedWith [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsCoregulatedWith [arguments] < ids > table.with.fields.added
