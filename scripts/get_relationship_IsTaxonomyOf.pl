...
get_relationship_IsTaxonomyOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsTaxonomyOf [arguments] < ids > table.with.fields.added
