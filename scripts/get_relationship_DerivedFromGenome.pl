...
get_relationship_DerivedFromGenome [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_DerivedFromGenome [arguments] < ids > table.with.fields.added
