...
get_relationship_EvaluatedIn

=head1 SYNOPSIS

get_relationship_EvaluatedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_EvaluatedIn [arguments] < ids > table.with.fields.added
