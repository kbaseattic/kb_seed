...
get_relationship_IsTreeFrom [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsTreeFrom [arguments] < ids > table.with.fields.added
