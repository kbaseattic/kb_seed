...
=head1 query_entity_OTU

Query the entity OTU.
...
my $usage = "usage: query_entity_OTU [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
