...
query_entity_OTU [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_OTU -is id,exact-match-value -a > records
...
query_entity_OTU [arguments] > records
