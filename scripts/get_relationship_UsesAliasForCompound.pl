...
get_relationship_UsesAliasForCompound [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_UsesAliasForCompound [arguments] < ids > table.with.fields.added
