...
get_relationship_MeasuresFeature

=head1 SYNOPSIS

get_relationship_MeasuresFeature [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_MeasuresFeature [arguments] < ids > table.with.fields.added
