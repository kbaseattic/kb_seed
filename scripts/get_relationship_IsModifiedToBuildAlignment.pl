...
get_relationship_IsModifiedToBuildAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsModifiedToBuildAlignment [arguments] < ids > table.with.fields.added
