...
=head1 query_entity_Compartment

Query the entity Compartment.
...
my $usage = "usage: query_entity_Compartment [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_Compartment(\@qry, \@fields );
