...
get_relationship_IsDisplayedOn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsDisplayedOn [arguments] < ids > table.with.fields.added
