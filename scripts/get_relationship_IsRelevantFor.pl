...
get_relationship_IsRelevantFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsRelevantFor [arguments] < ids > table.with.fields.added
