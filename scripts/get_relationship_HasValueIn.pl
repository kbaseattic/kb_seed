...
get_relationship_HasValueIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasValueIn [arguments] < ids > table.with.fields.added
