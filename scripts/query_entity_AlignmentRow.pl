...
query_entity_AlignmentRow

=head1 SYNOPSIS

query_entity_AlignmentRow [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_AlignmentRow -is id,exact-match-value -a > records
...
query_entity_AlignmentRow [arguments] > records
