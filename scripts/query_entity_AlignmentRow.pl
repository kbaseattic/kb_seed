...
=head1 query_entity_AlignmentRow

Query the entity AlignmentRow.
...
my $usage = "usage: query_entity_AlignmentRow [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
