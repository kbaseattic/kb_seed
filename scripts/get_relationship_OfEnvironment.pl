...
get_relationship_OfEnvironment

=head1 SYNOPSIS

get_relationship_OfEnvironment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_OfEnvironment [arguments] < ids > table.with.fields.added
