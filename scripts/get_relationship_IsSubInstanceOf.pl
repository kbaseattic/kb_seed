...
get_relationship_IsSubInstanceOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsSubInstanceOf [arguments] < ids > table.with.fields.added
