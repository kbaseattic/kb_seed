...
=head1 query_entity_Tree

Query the entity Tree.
...
my $usage = "usage: query_entity_Tree [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
