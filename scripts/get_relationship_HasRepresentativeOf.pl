...
get_relationship_HasRepresentativeOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasRepresentativeOf [arguments] < ids > table.with.fields.added
