...
get_relationship_HasAsSequence [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasAsSequence [arguments] < ids > table.with.fields.added
