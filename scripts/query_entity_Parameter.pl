...
query_entity_Parameter

=head1 SYNOPSIS

query_entity_Parameter [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Parameter -is id,exact-match-value -a > records
...
query_entity_Parameter [arguments] > records
