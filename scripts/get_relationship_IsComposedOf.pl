...
get_relationship_IsComposedOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsComposedOf [arguments] < ids > table.with.fields.added
