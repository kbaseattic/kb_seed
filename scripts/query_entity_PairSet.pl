...
query_entity_PairSet [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_PairSet -is id,exact-match-value -a > records
...
query_entity_PairSet [arguments] > records
