...
=head1 query_entity_PairSet

Query the entity PairSet.
...
my $usage = "usage: query_entity_PairSet [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
