...
=head1 query_entity_PhenotypeExperiment

Query the entity PhenotypeExperiment.
...
Example:
    ...
    query_entity_PhenotypeExperiment -a 
...
my $usage = "usage: query_entity_PhenotypeExperiment [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_PhenotypeExperiment(\@qry, \@fields );
