...
get_relationship_IsControlledUsing [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsControlledUsing [arguments] < ids > table.with.fields.added
