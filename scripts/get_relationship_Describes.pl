...
=head1 get_relationship_Describes
...
my $usage = "usage: get_relationship_Describes [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
