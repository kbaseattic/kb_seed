...
get_relationship_IncludedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IncludedIn [arguments] < ids > table.with.fields.added
