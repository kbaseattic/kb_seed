...
get_relationship_ConsistsOfCompounds [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_ConsistsOfCompounds [arguments] < ids > table.with.fields.added
