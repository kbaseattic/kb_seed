...
get_relationship_DeterminesFunctionOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_DeterminesFunctionOf [arguments] < ids > table.with.fields.added
