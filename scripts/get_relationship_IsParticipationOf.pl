...
get_relationship_IsParticipationOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsParticipationOf [arguments] < ids > table.with.fields.added
