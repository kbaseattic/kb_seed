...
query_entity_Protocol

=head1 SYNOPSIS

query_entity_Protocol [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Protocol -is id,exact-match-value -a > records
...
query_entity_Protocol [arguments] > records
