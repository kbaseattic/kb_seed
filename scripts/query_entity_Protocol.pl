...
=head1 query_entity_Protocol

Query the entity Protocol.
...
my $usage = "usage: query_entity_Protocol [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
