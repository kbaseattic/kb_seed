...
get_relationship_IsRegulatedSetOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsRegulatedSetOf [arguments] < ids > table.with.fields.added
