...
get_relationship_IsATopicOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsATopicOf [arguments] < ids > table.with.fields.added
