...
query_entity_Annotation [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Annotation -is id,exact-match-value -a > records
...
query_entity_Annotation [arguments] > records
