...
=head1 query_entity_Diagram

Query the entity Diagram.
...
my $usage = "usage: query_entity_Diagram [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
