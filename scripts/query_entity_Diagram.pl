...
query_entity_Diagram [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Diagram -is id,exact-match-value -a > records
...
query_entity_Diagram [arguments] > records
