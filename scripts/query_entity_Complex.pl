...
query_entity_Complex [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Complex -is id,exact-match-value -a > records
...
query_entity_Complex [arguments] > records
