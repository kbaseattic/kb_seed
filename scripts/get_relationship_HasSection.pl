...
get_relationship_HasSection [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasSection [arguments] < ids > table.with.fields.added
