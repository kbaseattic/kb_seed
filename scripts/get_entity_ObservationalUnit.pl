...
get_entity_ObservationalUnit [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_entity_ObservationalUnit [arguments] < ids > table.with.fields.added
