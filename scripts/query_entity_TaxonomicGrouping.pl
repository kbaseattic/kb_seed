...
=head1 query_entity_TaxonomicGrouping

Query the entity TaxonomicGrouping.
...
Example:
    ...
    query_entity_TaxonomicGrouping -a 
...
my $usage = "usage: query_entity_TaxonomicGrouping [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
