...
query_entity_TaxonomicGrouping [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_TaxonomicGrouping -is id,exact-match-value -a > records
...
query_entity_TaxonomicGrouping [arguments] > records
