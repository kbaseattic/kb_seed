...
=head1 get_relationship_IsManagedBy
...
my @all_from_fields = ( 'id', 'mod_date', 'name' );
...
my $usage = "usage: get_relationship_IsManagedBy [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
