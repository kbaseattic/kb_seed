...
get_relationship_IsFunctionalIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsFunctionalIn [arguments] < ids > table.with.fields.added
