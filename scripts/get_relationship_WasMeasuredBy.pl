...
get_relationship_WasMeasuredBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_WasMeasuredBy [arguments] < ids > table.with.fields.added
