...
get_relationship_IsSequenceOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsSequenceOf [arguments] < ids > table.with.fields.added
