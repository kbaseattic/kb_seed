...
get_relationship_IsMemberOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsMemberOf [arguments] < ids > table.with.fields.added
