...
query_entity_ObservationalUnit [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ObservationalUnit -is id,exact-match-value -a > records
...
query_entity_ObservationalUnit [arguments] > records
