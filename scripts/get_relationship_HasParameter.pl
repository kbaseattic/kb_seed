...
get_relationship_HasParameter

=head1 SYNOPSIS

get_relationship_HasParameter [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    get_relationship_HasParameter -a < ids > table.with.fields.added
...
Usage: get_relationship_HasParameter [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "get_relationship_HasParameter: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
