...
=head1 all_entities_LocalizedCompound
...
Example:
    ...
    all_entities_LocalizedCompound -a 
...
my $usage = "usage: all_entities_LocalizedCompound [-show-fields] [-a | -f field list] > entity.data";
