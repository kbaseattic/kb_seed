...
get_relationship_KnockedOutIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_KnockedOutIn [arguments] < ids > table.with.fields.added
