...
query_entity_ContigSequence [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ContigSequence -is id,exact-match-value -a > records
...
query_entity_ContigSequence [arguments] > records
