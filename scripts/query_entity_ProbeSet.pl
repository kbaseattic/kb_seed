...
query_entity_ProbeSet [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ProbeSet -is id,exact-match-value -a > records
...
query_entity_ProbeSet [arguments] > records
