...
=head1 query_entity_ProbeSet

Query the entity ProbeSet.
...
my $usage = "usage: query_entity_ProbeSet [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
