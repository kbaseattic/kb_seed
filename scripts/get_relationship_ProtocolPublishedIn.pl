...
get_relationship_ProtocolPublishedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_ProtocolPublishedIn [arguments] < ids > table.with.fields.added
