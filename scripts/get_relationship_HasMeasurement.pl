...
get_relationship_HasMeasurement [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasMeasurement [arguments] < ids > table.with.fields.added
