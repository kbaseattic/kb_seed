...
get_relationship_HasMedia

=head1 SYNOPSIS

get_relationship_HasMedia [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasMedia [arguments] < ids > table.with.fields.added
