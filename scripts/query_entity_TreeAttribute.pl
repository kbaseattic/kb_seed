...
query_entity_TreeAttribute

=head1 SYNOPSIS

query_entity_TreeAttribute [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_TreeAttribute -is id,exact-match-value -a > records
...
query_entity_TreeAttribute [arguments] > records
