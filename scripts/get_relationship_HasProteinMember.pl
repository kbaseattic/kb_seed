...
get_relationship_HasProteinMember [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasProteinMember [arguments] < ids > table.with.fields.added
