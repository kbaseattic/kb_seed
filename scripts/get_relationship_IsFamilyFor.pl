...
get_relationship_IsFamilyFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsFamilyFor [arguments] < ids > table.with.fields.added
