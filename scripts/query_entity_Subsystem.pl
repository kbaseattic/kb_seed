...
query_entity_Subsystem [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Subsystem -is id,exact-match-value -a > records
...
query_entity_Subsystem [arguments] > records
