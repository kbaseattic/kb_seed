...
=head1 query_entity_Environment

Query the entity Environment.
...
my $usage = "usage: query_entity_Environment [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
