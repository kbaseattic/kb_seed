...
query_entity_Environment

=head1 SYNOPSIS

query_entity_Environment [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Environment -is id,exact-match-value -a > records
...
query_entity_Environment [arguments] > records
