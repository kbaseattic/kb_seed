...
get_relationship_Encompasses [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_Encompasses [arguments] < ids > table.with.fields.added
