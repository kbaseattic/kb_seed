...
get_relationship_IsVariedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsVariedIn [arguments] < ids > table.with.fields.added
