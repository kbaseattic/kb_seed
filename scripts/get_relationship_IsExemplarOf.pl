...
get_relationship_IsExemplarOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsExemplarOf [arguments] < ids > table.with.fields.added
