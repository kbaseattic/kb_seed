...
=head1 query_entity_Biomass

Query the entity Biomass.
...
my $usage = "usage: query_entity_Biomass [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
