...
get_relationship_AreCodonsFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_AreCodonsFor [arguments] < ids > table.with.fields.added
