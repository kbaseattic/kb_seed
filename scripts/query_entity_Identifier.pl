...
my $usage = "usage: query_entity_Identifier [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_Identifier(\@qry, \@fields );
