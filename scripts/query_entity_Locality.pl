...
=head1 query_entity_Locality

Query the entity Locality.

A locality is a geographic location.

Example:

    query_entity_Locality -a 
...
my $usage = "usage: query_entity_Locality [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
