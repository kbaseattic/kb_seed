...
query_entity_Locality [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Locality -is id,exact-match-value -a > records
...
query_entity_Locality [arguments] > records
