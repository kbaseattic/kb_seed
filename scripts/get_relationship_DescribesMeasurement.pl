...
=head1 get_relationship_DescribesMeasurement
...
Choose a set of fields from the MeasurementDescription entity to return. Field-list is a comma-separated list of 
...
my $usage = "usage: get_relationship_DescribesMeasurement [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
