...
get_relationship_UsesAliasForReaction [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_UsesAliasForReaction [arguments] < ids > table.with.fields.added
