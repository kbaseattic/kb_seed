...
my @all_fields = ( 'mod_date', 'name', 'abbr', 'equation', 'reversibility' );
my %all_fields = map { $_ => 1 } @all_fields;

my $usage = "usage: get_entity_Reaction [-c column] [-a | -f field list] < ids > extended.by.a.column(s)";
