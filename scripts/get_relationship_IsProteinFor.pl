...
get_relationship_IsProteinFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsProteinFor [arguments] < ids > table.with.fields.added
