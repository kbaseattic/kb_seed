...
query_entity_Publication [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Publication -is id,exact-match-value -a > records
...
query_entity_Publication [arguments] > records
