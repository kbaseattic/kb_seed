...
get_relationship_IsContextOf

=head1 SYNOPSIS

get_relationship_IsContextOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    get_relationship_IsContextOf -a < ids > table.with.fields.added
...
Usage: get_relationship_IsContextOf [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "get_relationship_IsContextOf: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
