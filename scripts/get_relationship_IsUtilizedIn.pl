...
get_relationship_IsUtilizedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsUtilizedIn [arguments] < ids > table.with.fields.added
