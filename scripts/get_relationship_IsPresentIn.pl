...
get_relationship_IsPresentIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsPresentIn [arguments] < ids > table.with.fields.added
