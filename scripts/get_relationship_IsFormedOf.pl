...
get_relationship_IsFormedOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsFormedOf [arguments] < ids > table.with.fields.added
