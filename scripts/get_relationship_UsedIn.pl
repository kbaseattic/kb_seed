...
get_relationship_UsedIn

=head1 SYNOPSIS

get_relationship_UsedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_UsedIn [arguments] < ids > table.with.fields.added
