...
query_entity_Media [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Media -is id,exact-match-value -a > records
...
query_entity_Media [arguments] > records
