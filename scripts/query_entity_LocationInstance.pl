...
=head1 query_entity_LocationInstance

Query the entity LocationInstance.
...
Example:
    ...
    query_entity_LocationInstance -a 
...
my $usage = "usage: query_entity_LocationInstance [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
