...
query_entity_LocationInstance

=head1 SYNOPSIS

query_entity_LocationInstance [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_LocationInstance -is id,exact-match-value -a > records
...
query_entity_LocationInstance [arguments] > records
