...
=head1 get_relationship_IsRelevantTo
...
my $usage = "usage: get_relationship_IsRelevantTo [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
