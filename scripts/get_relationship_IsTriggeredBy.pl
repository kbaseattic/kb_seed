...
my @all_from_fields = ( 'id', 'name', 'mod_date' );
...
my $usage = "usage: get_relationship_IsTriggeredBy [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)";
