...
=head1 query_entity_Experiment

Query the entity Experiment.
...
my $usage = "usage: query_entity_Experiment [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
