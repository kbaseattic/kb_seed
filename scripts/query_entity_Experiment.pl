...
query_entity_Experiment [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Experiment -is id,exact-match-value -a > records
...
query_entity_Experiment [arguments] > records
