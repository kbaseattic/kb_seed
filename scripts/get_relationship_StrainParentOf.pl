...
get_relationship_StrainParentOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_StrainParentOf [arguments] < ids > table.with.fields.added
