...
get_relationship_HasNodeAttribute [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasNodeAttribute [arguments] < ids > table.with.fields.added
