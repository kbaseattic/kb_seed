...
get_relationship_DescribesTree [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_DescribesTree [arguments] < ids > table.with.fields.added
