...
get_relationship_IsCoupledTo [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsCoupledTo [arguments] < ids > table.with.fields.added
