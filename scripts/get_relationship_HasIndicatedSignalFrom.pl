...
=head1 get_relationship_HasIndicatedSignalFrom
...
my $usage = "usage: get_relationship_HasIndicatedSignalFrom [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
