...
get_relationship_IsReferencedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsReferencedBy [arguments] < ids > table.with.fields.added
