...
get_relationship_IndicatesSignalFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IndicatesSignalFor [arguments] < ids > table.with.fields.added
