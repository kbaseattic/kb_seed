...
get_relationship_ParticipatesIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_ParticipatesIn [arguments] < ids > table.with.fields.added
