...
get_relationship_WasProvidedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_WasProvidedBy [arguments] < ids > table.with.fields.added
