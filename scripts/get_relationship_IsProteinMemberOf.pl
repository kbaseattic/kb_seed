...
get_relationship_IsProteinMemberOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsProteinMemberOf [arguments] < ids > table.with.fields.added
