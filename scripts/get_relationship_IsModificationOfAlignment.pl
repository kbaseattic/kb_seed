...
get_relationship_IsModificationOfAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsModificationOfAlignment [arguments] < ids > table.with.fields.added
