...
query_entity_ContigChunk [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ContigChunk -is id,exact-match-value -a > records
...
query_entity_ContigChunk [arguments] > records
