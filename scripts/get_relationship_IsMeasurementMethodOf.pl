...
get_relationship_IsMeasurementMethodOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsMeasurementMethodOf [arguments] < ids > table.with.fields.added
