...
get_relationship_WasAlignedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_WasAlignedBy [arguments] < ids > table.with.fields.added
