...
query_entity_ProteinSequence [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ProteinSequence -is id,exact-match-value -a > records
...
query_entity_ProteinSequence [arguments] > records
