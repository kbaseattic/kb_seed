...
=head1 query_entity_SSRow

Query the entity SSRow.
...
my $usage = "usage: query_entity_SSRow [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
