...
query_entity_Assay [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Assay -is id,exact-match-value -a > records
...
query_entity_Assay [arguments] > records
