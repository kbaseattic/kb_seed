...
get_relationship_HasAsExemplar [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasAsExemplar [arguments] < ids > table.with.fields.added
