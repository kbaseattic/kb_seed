...
query_entity_Family [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Family -is id,exact-match-value -a > records
...
query_entity_Family [arguments] > records
