...
get_relationship_IsConsistentWith [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsConsistentWith [arguments] < ids > table.with.fields.added
