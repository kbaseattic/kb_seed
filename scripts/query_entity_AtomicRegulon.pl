...
query_entity_AtomicRegulon [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_AtomicRegulon -is id,exact-match-value -a > records
...
query_entity_AtomicRegulon [arguments] > records
