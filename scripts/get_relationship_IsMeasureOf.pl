...
get_relationship_IsMeasureOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsMeasureOf [arguments] < ids > table.with.fields.added
