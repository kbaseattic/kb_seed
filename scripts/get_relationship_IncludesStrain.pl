...
get_relationship_IncludesStrain [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IncludesStrain [arguments] < ids > table.with.fields.added
