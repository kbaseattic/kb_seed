...
get_relationship_HasAssertedFunctionFrom [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasAssertedFunctionFrom [arguments] < ids > table.with.fields.added
