...
query_entity_AlleleFrequency [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_AlleleFrequency -is id,exact-match-value -a > records
...
query_entity_AlleleFrequency [arguments] > records
