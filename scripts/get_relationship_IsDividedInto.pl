...
get_relationship_IsDividedInto [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsDividedInto [arguments] < ids > table.with.fields.added
