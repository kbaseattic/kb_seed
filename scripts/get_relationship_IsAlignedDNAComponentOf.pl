...
get_relationship_IsAlignedDNAComponentOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsAlignedDNAComponentOf [arguments] < ids > table.with.fields.added
