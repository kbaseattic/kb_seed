...
get_relationship_ComponentOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_ComponentOf [arguments] < ids > table.with.fields.added
