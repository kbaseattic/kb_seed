...
query_entity_SubsystemClass [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_SubsystemClass -is id,exact-match-value -a > records
...
query_entity_SubsystemClass [arguments] > records
