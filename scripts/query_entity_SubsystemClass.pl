...
=head1 query_entity_SubsystemClass

Query the entity SubsystemClass.
...
my $usage = "usage: query_entity_SubsystemClass [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
