...
=head1 query_entity_Strain

Query the entity Strain.
...
my $usage = "usage: query_entity_Strain [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
