...
query_entity_Strain [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Strain -is id,exact-match-value -a > records
...
query_entity_Strain [arguments] > records
