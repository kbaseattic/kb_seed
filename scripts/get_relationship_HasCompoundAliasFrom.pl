...
get_relationship_HasCompoundAliasFrom [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasCompoundAliasFrom [arguments] < ids > table.with.fields.added
