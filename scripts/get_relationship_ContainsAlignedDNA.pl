...
get_relationship_ContainsAlignedDNA [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_ContainsAlignedDNA [arguments] < ids > table.with.fields.added
