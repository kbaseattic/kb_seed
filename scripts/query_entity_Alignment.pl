...
=head1 query_entity_Alignment

Query the entity Alignment.
...
my $usage = "usage: query_entity_Alignment [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
