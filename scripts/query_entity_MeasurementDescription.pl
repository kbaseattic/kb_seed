...
query_entity_MeasurementDescription

=head1 SYNOPSIS

query_entity_MeasurementDescription [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_MeasurementDescription -is id,exact-match-value -a > records
...
query_entity_MeasurementDescription [arguments] > records
