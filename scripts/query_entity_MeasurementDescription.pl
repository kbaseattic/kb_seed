...
=head1 query_entity_MeasurementDescription

Query the entity MeasurementDescription.
...
Example:
    ...
    query_entity_MeasurementDescription -a 
...
my $usage = "usage: query_entity_MeasurementDescription [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
