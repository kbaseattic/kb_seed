...
=head1 get_relationship_HadResultsProducedBy
...
my $usage = "usage: get_relationship_HadResultsProducedBy [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)";
