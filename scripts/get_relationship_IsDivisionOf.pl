...
get_relationship_IsDivisionOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsDivisionOf [arguments] < ids > table.with.fields.added
