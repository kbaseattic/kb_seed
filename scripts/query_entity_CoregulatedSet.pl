...
query_entity_CoregulatedSet [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_CoregulatedSet -is id,exact-match-value -a > records
...
query_entity_CoregulatedSet [arguments] > records
