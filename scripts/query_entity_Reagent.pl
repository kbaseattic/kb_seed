...
=head1 query_entity_Reagent

Query the entity Reagent.
...
my $usage = "usage: query_entity_Reagent [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_Reagent(\@qry, \@fields );
