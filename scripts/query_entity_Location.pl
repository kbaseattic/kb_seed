...
query_entity_Location

=head1 SYNOPSIS

query_entity_Location [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Location -is id,exact-match-value -a > records
...
query_entity_Location [arguments] > records
