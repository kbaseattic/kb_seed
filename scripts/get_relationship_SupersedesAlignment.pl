...
get_relationship_SupersedesAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_SupersedesAlignment [arguments] < ids > table.with.fields.added
