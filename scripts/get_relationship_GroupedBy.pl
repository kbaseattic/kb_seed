...
get_relationship_GroupedBy

=head1 SYNOPSIS

get_relationship_GroupedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_GroupedBy [arguments] < ids > table.with.fields.added
