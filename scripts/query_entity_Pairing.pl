...
query_entity_Pairing [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Pairing -is id,exact-match-value -a > records
...
query_entity_Pairing [arguments] > records
