...
=head1 query_entity_PhenotypeDescription

Query the entity PhenotypeDescription.

A Phenotype is a measurable characteristic of an organism.

Example:

    query_entity_PhenotypeDescription -a 
...
my $usage = "usage: query_entity_PhenotypeDescription [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_PhenotypeDescription(\@qry, \@fields );
