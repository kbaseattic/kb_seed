...
get_relationship_DescribesTreeNode [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_DescribesTreeNode [arguments] < ids > table.with.fields.added
