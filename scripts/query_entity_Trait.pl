...
query_entity_Trait [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Trait -is id,exact-match-value -a > records
...
query_entity_Trait [arguments] > records
