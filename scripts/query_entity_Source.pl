...
query_entity_Source [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Source -is id,exact-match-value -a > records
...
query_entity_Source [arguments] > records
