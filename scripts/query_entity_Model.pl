...
query_entity_Model [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Model -is id,exact-match-value -a > records
...
query_entity_Model [arguments] > records
