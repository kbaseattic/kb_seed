...
=head1 get_relationship_WasGeneratedFrom
...
my $usage = "usage: get_relationship_WasGeneratedFrom [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
