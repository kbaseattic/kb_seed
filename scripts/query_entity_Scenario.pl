...
query_entity_Scenario [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Scenario -is id,exact-match-value -a > records
...
query_entity_Scenario [arguments] > records
