...
=head1 query_entity_Scenario

Query the entity Scenario.
...
my $usage = "usage: query_entity_Scenario [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
