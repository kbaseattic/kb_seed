...
get_relationship_IsFormedInto [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsFormedInto [arguments] < ids > table.with.fields.added
