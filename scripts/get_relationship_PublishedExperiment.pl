...
get_relationship_PublishedExperiment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_PublishedExperiment [arguments] < ids > table.with.fields.added
