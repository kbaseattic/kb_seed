...
=head1 query_entity_AlignmentTree
...
my $usage = "usage: query_entity_AlignmentTree [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
...
my $h = $geO->query_entity_AlignmentTree(\@qry, \@fields );
