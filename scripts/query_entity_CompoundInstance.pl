...
query_entity_CompoundInstance

=head1 SYNOPSIS

query_entity_CompoundInstance [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_CompoundInstance -is id,exact-match-value -a > records
...
query_entity_CompoundInstance [arguments] > records
