...
=head1 query_entity_CompoundInstance

Query the entity CompoundInstance.
...
Example:
    ...
    query_entity_CompoundInstance -a 
...
my $usage = "usage: query_entity_CompoundInstance [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
