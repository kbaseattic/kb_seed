...
get_relationship_DefinedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    get_relationship_DefinedBy -a < ids > table.with.fields.added
...
Usage: get_relationship_DefinedBy [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "get_relationship_DefinedBy: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
