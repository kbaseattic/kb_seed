...
query_entity_EcNumber [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_EcNumber -is id,exact-match-value -a > records
...
query_entity_EcNumber [arguments] > records
