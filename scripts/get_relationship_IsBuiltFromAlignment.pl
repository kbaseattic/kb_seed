...
get_relationship_IsBuiltFromAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsBuiltFromAlignment [arguments] < ids > table.with.fields.added
