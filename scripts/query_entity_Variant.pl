...
query_entity_Variant [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Variant -is id,exact-match-value -a > records
...
query_entity_Variant [arguments] > records
