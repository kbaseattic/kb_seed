...
get_relationship_HasRequirementOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasRequirementOf [arguments] < ids > table.with.fields.added
