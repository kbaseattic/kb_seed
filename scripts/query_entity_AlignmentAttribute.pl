...
query_entity_AlignmentAttribute

=head1 SYNOPSIS

query_entity_AlignmentAttribute [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_AlignmentAttribute -is id,exact-match-value -a > records
...
query_entity_AlignmentAttribute [arguments] > records
