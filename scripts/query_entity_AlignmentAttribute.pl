...
=head1 query_entity_AlignmentAttribute

Query the entity AlignmentAttribute.
...
Example:
    ...
    query_entity_AlignmentAttribute -a 
...
my $usage = "usage: query_entity_AlignmentAttribute [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
