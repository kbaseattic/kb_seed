...
get_relationship_IsDefinedBy

=head1 SYNOPSIS

get_relationship_IsDefinedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsDefinedBy [arguments] < ids > table.with.fields.added
