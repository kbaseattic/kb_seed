...
get_relationship_IsTimepointOf

=head1 SYNOPSIS

get_relationship_IsTimepointOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsTimepointOf [arguments] < ids > table.with.fields.added
