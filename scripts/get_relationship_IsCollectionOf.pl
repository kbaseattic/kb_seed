...
get_relationship_IsCollectionOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsCollectionOf [arguments] < ids > table.with.fields.added
