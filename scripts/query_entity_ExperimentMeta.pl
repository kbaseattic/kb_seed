...
query_entity_ExperimentMeta

=head1 SYNOPSIS

query_entity_ExperimentMeta [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ExperimentMeta -is id,exact-match-value -a > records
...
query_entity_ExperimentMeta [arguments] > records
