...
=head1 query_entity_ExperimentMeta

Query the entity ExperimentMeta.
...
my $usage = "usage: query_entity_ExperimentMeta [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
