...
get_relationship_IsIncludedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsIncludedIn [arguments] < ids > table.with.fields.added
