...
get_relationship_HasTreeAttribute [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasTreeAttribute [arguments] < ids > table.with.fields.added
