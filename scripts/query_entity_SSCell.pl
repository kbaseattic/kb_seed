...
=head1 query_entity_SSCell

Query the entity SSCell.
...
my $usage = "usage: query_entity_SSCell [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
