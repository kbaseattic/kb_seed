...
get_relationship_IsEncompassedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsEncompassedIn [arguments] < ids > table.with.fields.added
