...
query_entity_Measurement

=head1 SYNOPSIS

query_entity_Measurement [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Measurement -is id,exact-match-value -a > records
...
query_entity_Measurement [arguments] > records
