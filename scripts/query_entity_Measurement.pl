...
=head1 query_entity_Measurement

Query the entity Measurement.
...
my $usage = "usage: query_entity_Measurement [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
