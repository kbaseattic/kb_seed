...
=head1 get_relationship_IsInClass
...
my $usage = "usage: get_relationship_IsInClass [-c column] [-a | -from field list -rel field list -to field list] < ids > extended.by.a.column(s)\n";
