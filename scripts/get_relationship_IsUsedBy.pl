...
get_relationship_IsUsedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_IsUsedBy [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "get_relationship_IsUsedBy: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
