...
=head1 query_entity_TimeSeries

Query the entity TimeSeries.
...
my $usage = "usage: query_entity_TimeSeries [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
