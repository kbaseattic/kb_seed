...
query_entity_Reaction [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Reaction -is id,exact-match-value -a > records
...
query_entity_Reaction [arguments] > records
