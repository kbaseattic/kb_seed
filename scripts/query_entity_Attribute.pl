...
query_entity_Attribute [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_Attribute -is id,exact-match-value -a > records
...
query_entity_Attribute [arguments] > records
