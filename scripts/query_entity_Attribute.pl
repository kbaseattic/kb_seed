...
=head1 query_entity_Attribute

Query the entity Attribute.
...
my $usage = "usage: query_entity_Attribute [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
