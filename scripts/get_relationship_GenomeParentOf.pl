...
get_relationship_GenomeParentOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_GenomeParentOf [arguments] < ids > table.with.fields.added
