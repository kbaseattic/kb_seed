...
get_relationship_WasSubmittedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_WasSubmittedBy [arguments] < ids > table.with.fields.added
