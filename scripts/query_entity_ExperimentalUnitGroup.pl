...
=head1 query_entity_ExperimentalUnitGroup

Query the entity ExperimentalUnitGroup.
...
Example:
    ...
    query_entity_ExperimentalUnitGroup -a 
...
my $usage = "usage: query_entity_ExperimentalUnitGroup [-is field,value] [-like field,value] [-op operator,field,value] [-show-fields] [-a | -f field list] > entity.data";
