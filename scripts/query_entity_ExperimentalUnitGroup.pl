...
query_entity_ExperimentalUnitGroup

=head1 SYNOPSIS

query_entity_ExperimentalUnitGroup [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    query_entity_ExperimentalUnitGroup -is id,exact-match-value -a > records
...
query_entity_ExperimentalUnitGroup [arguments] > records
