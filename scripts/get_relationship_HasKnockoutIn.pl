...
get_relationship_HasKnockoutIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Usage: get_relationship_HasKnockoutIn [arguments] < ids > table.with.fields.added
