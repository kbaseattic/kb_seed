...
my $test_method = "proteins_to_functions";
my @additional_args = (
        [],
...
#$good_data = $cdmi->proteins_to_functions([keys %$good_data]);
...
my $sample_data = [
    ...
    { 'id' => '00009b96f4119b8876c59df7da6681f6', 'expected' => [
                                                  [
                                                    'kb|g.2811.peg.492',
                                                    'Thiamine kinase (EC 2.7.1.89) @ Adenosylcobinamide kinase (EC 2.7.1.156)'
                                                  ]
                                                ]
    },
