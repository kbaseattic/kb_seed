...
cs-proteins-to-functions

=head1 SYNOPSIS

cs-proteins-to-functions [arguments] < input > output
...
Usage: cs-proteins-to-functions [arguments] < input > output
...
our $usage = "usage: cs-proteins-to-functions [-c column] < input > output";
