...
cs-get -p Path [-c Constraint] [-f Fields] > outut
...
Example:
    ...
    cs-get 'Feature,Produces,Sequence' 'Feature.id = kb|g.0.peg.4' 'ProteinSequence.sequence'
...
our $usage = "usage: cs-get -p Path [-c Constraint] [-f Fields] > outut";
