...
cs-fids-to-locations

=head1 SYNOPSIS

cs-fids-to-locations [arguments] < input > output
...
Usage: cs-fids-to-locations [arguments] < input > output
...
our $usage = "usage: cs-fids-to-locations [-c column] < input > output";
