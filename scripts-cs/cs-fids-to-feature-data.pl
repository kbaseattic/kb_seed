...
cs-fids-to-feature-data

=head1 SYNOPSIS

cs-fids-to-feature-data [arguments] < input > output
...
Usage: cs-fids-to-feature-data [arguments] < input > output
...
our $usage = "usage: cs-fids-to-feature-data [-c column] < input > output";
