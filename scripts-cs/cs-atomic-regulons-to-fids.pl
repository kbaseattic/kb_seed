...
cs-atomic-regulons-to-fids

=head1 SYNOPSIS

cs-atomic-regulons-to-fids [arguments] < input > output
...
Usage: cs-atomic-regulons-to-fids [arguments] < input > output
...
our $usage = "usage: cs-atomic-regulons-to-fids [-c column] < input > output";
