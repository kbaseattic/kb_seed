...
cs-fids-to-annotations

=head1 SYNOPSIS

cs-fids-to-annotations [arguments] < input > output
...
Usage: cs-fids-to-annotations [arguments] < input > output
...
our $usage = "usage: cs-fids-to-annotations [-c column] < input > output";
