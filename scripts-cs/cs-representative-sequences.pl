...
cs-representative-sequences

=head1 SYNOPSIS

cs-representative-sequences [arguments] < input > output
...
Usage: cs-representative-sequences [arguments] < input > output
...
our $usage = "usage: cs-representative-sequences [arguments] < input > output";
