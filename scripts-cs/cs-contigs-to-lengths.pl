...
cs-contigs-to-lengths

=head1 SYNOPSIS

cs-ontigs-to-lengths [arguments] < input > output
...
Example:
    ...
    cs-contigs-to-lengths [arguments] < input > output
...
Usage: cs-contigs-to-lengths [arguments] < input > output
...
our $usage = "usage: cs-contigs-to-lengths [-c column] < input > output";
