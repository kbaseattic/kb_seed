...
cs-genomes-to-fids [arguments] < input > output

=head1 DESCRIPTION


cs-genomes-to-fids is used to get the fids included in specific genomes.  It
...
Usage: cs-genomes-to-fids [arguments] < input > output
...
our $usage = "usage: cs-genomes-to-fids [-c column] < input > output";
