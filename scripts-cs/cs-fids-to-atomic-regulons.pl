...
cs-fids-to-atomic-regulons

=head1 SYNOPSIS

cs-fids-to-atomic-regulons [arguments] < input > output
...
Usage: cs-fids-to-atomic-regulons [arguments] < input > output
...
our $usage = "usage: cs-fids-to-atomic-regulons [-c column] < input > output";
