...
cs-subsystems-to-fids

=head1 SYNOPSIS

cs-subsystems-to-fids [arguments] < input > output
...
Usage: cs-subsystems-to-fids [arguments] < input > output
...
our $usage = "usage: cs-subsystems-to-fids [-c column] < input > output";
