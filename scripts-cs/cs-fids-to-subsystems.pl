...
cs-fids-to-subsystems

=head1 SYNOPSIS

cs-fids-to-subsystems [arguments] < input > output
...
Usage: cs-fids-to-subsystems [arguments] < input > output
...
our $usage = "usage: cs-fids-to-subsystems [-c column] < input > output";
