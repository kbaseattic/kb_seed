...
cs-all-roles-used-in-models

=head1 SYNOPSIS

cs-all-roles-used-in-models > output

=head1 DESCRIPTION

The cs-all-roles-used-in-models allows a user to access the set of roles that are included in current models.
...
Usage: cs-all-roles-used-in-models > output
...
our $usage = "usage: cs-all-roles-used-in-models > output";
