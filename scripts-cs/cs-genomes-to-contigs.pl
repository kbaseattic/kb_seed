...
cs-genomes-to-contigs [arguments] < input > output

=head1 DESCRIPTION


The routine cs-genomes-to-contigs can be used to retrieve the IDs of the contigs
...
Usage: cs-genomes-to-contigs [arguments] < input > output
...
our $usage = "usage: cs-genomes-to-contigs [-c column] < input > output";
