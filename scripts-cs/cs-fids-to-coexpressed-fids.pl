...
cs-fids-to-coexpressed-fids

=head1 SYNOPSIS

cs-fids-to-coexpressed-fids [arguments] < input > output

=head1 DESCRIPTION


The routine cs-fids-to-coexpressed-fids returns (for each input fid) a
...
Usage: cs-fids-to-coexpressed-fids [arguments] < input > output
...
our $usage = "usage: cs-fids-to-coexpressed-fids [-c column] < input > output";
