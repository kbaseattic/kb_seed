...
cs-locations-to-fids

=head1 SYNOPSIS

cs-locations-to-fids [arguments] < input > output
...
Usage: cs-locations-to-fids [arguments] < input > output
...
our $usage = "usage: cs-locations-to-fids [-c column] < input > output";
