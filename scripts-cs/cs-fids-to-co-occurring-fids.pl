...
cs-fids-to-co-occurring_fids

=head1 SYNOPSIS

cs-fids-to-co-occurring_fids [arguments] < input > output
...
Usage: cs-fids-to-co-occurring_fids [arguments] < input > output
...
our $usage = "usage: cs-fids-to-co-occurring_fids [-c column] < input > output";
