...
cs-contigs-to-sequences

=head1 SYNOPSIS

cs-contigs-to-sequences [arguments] < input > output

=head1 DESCRIPTION


cs-contigs-to-sequences is used to access the DNA sequence associated with each of a set
...
Usage: cs-contigs-to-sequences [arguments] < input > output
...
our $usage = "usage: cs-contigs-to-sequences [-c column] < input > output";
