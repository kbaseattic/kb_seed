...
cs-otus-to-representatives

=head1 SYNOPSIS

cs-otus-to-representatives [arguments] < input > output
...
Usage: cs-otus-to-representatives [arguments] < input > output
...
our $usage = "usage: cs-otus-to-representatives [-c column] < input > output";
