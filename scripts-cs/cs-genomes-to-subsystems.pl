...
cs-genomes-to-subsystems

=head1 SYNOPSIS

cs-genomes-to-subsystems [arguments] < input > output
...
Usage: cs-genomes-to-subsystems [arguments] < input > output
...
our $usage = "usage: cs-genomes-to-subsystems [-c column] < input > output";
