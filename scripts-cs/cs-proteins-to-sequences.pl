...
cs-proteins-to-sequences

=head1 SYNOPSIS

cs-proteins-to-sequences [arguments] < input > output

=head1 DESCRIPTION


cs-proteins-to-sequences allows the user to look up the amino acid sequences
...
my $usage = "usage: cs-proteins-to-sequences [-c column] < input > output";
