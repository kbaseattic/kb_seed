...
cs-fids-to-protein-sequences

=head1 SYNOPSIS

cs-fids-to-protein-sequences [arguments] < input > output

=head1 DESCRIPTION


cs-fids-to-protein-sequences allows the user to look up the amino acid sequences
...
Usage: cs-fids-to-protein-sequences [arguments] < input > output
...
our $usage = "usage: cs-fids-to-protein-sequences [-c column] < input > output";
