...
cs-fids-to-protein-families

=head1 SYNOPSIS

cs-fids-to-protein-families [arguments] < input > output
...
Usage: cs-fids-to-protein-families [arguments] < input > output
...
our $usage = "usage: cs-fids-to-protein-families [-c column] < input > output";
