...
cs-otu-members [arguments] < input > output
...
Usage: cs-otu-members [arguments] < input > output
...
our $usage = "usage: cs-otu-members [-c column] < input > output";
