...
cs-subsystems-to-spreadsheets

=head1 SYNOPSIS

cs-subsystems-to-spreadsheets [arguments] < input > output

=head1 DESCRIPTION

The cs-subsystems-to-spreadsheets command allows the user to output the entire spreadsheet for 
...
Usage: v [arguments] < input > output
...
our $usage = "usage: cs-subsystems-to-spreadsheets [-c column] [g1 g2 g3 ...] < input > output";
