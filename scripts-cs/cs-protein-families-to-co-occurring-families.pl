...
cs-protein-families-to-co-occurring-families

=head1 SYNOPSIS

cs-protein-families-to-co-occurring-families [arguments] < input > output
...
Usage: cs-protein-families-to-co-occurring-families [arguments] < input > output
...
our $usage = "usage: cs-protein-families-to-co-occurring-families [-c column] < input > output";
