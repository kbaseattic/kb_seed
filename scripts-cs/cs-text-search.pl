...
cs-text-search [arguments] < input > output

=head1 DESCRIPTION


cs-text-search performs a search against a full-text index maintained 
...
Usage: cs-text-search [arguments] < input > output
...
our $usage = "usage: cs-text-search [-start N] [-count N] [-entity name -entity name ..] search-string\n";
