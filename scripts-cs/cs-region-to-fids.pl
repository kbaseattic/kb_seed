...
cs-region-to-fids [arguments] <input > output
...
Example:
    ...
    cs-region-to-fids -d 10000 < input > output [gets fids within 10kb of the positions]
...
Usage: cs-region-to-fids [arguments] <input > output
...
our $usage = "usage: cs-region-to-fids [-c column] [-d distance] < input > output";
