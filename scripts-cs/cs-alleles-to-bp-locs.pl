...
cs-alleles-to-bp-locs

=head1 SYNOPSIS

cs-alleles-to-bp-locs [arguments] < input > output
...
Usage: cs-alleles-to-bp-locs [arguments] < input > output
...
our $usage = "usage: cs-alleles-to-bp-locs [-c column] < input > output";
