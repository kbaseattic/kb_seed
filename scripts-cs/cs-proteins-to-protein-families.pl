...
cs-proteins-to-protein-families

=head1 SYNOPSIS

cs-proteins-to-protein-families [arguments] < input > output
...
Usage: cs-proteins-to-protein-families [arguments] < input > output
...
our $usage = "usage: cs-proteins-to-protein-families [-c column] < input > output";
