...
cs-genomes-to-genome-data

=head1 SYNOPSIS

cs-genomes-to-genome-data [arguments] < input > output
...
Usage: cs-genomes-to-genome-data [arguments] < input > output
...
our $usage = "usage: cs-genomes-to-genome-data [-c column] < input > output";
