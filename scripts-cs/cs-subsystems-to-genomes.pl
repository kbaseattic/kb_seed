...
cs-subsystems-to-genomes

=head1 SYNOPSIS

cs-subsystems-to-genomes [arguments] < input > output
...
Usage: cs-subsystems-to-genomes [arguments] < input > output
...
our $usage = "usage: cs-subsystems-to-genomes [-c column] < input > output";
