...
cs-equiv-sequence-assertions

=head1 SYNOPSIS

cs-equiv-sequence-assertions [arguments] < input > output

=head1 DESCRIPTION


Different groups have made assertions of function for numerous protein sequences.
The cs-equiv-sequence-assertions allows the user to gather function assertions from
...
Usage: cs-equiv-sequence-assertions [arguments] < input > output
...
our $usage = "usage: cs-equiv-sequence-assertions [-c column] < input > output";
