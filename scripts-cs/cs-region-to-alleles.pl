...
cs-region-to-alleles

=head1 SYNOPSIS

cs-region-to-alleles [-c Column] [-d regionSize] < input > output
cs-region-to-alleles [-c Column] [-d regionSize] -i input > output

=head1 DESCRIPTION

Example:

    cs-region-to-alleles [-d 10000] < input > output
...
Usage: cs-region-to-alleles [-c Column] [-d regionSize] < input > output
Usage: cs-region-to-alleles [-c Column] [-d regionSize] -i input > output
...
our $usage = "usage: cs-region-to-alleles [-c column] < input > output";
