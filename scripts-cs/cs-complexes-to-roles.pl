...
cs-complexes-to-roles [arguments] < input > output
...
If you need that information, we recommend that you use
    ...
    er-get-relationship-IsTriggeredBy -rel optional -to id
...
Usage: cs-complexes-to-roles [arguments] < input > output
...
our $usage = "usage: cs-complexes-to-roles [-c column] < input > output";
