...
cs-ous-with-trait -g Genome -mtype MeasurementType -min MinVal -max MaxVal < traits_input > output_with_ous
...
Usage: cs-ous-with-trait -g Genome -mtype MeasurementType -min MinVal -max MaxVal < traits_input > output_with_ous
...
our $usage = "usage: cs-ous-with-trait [-c column] < input > output";
