...
cs-proteins-to-roles

=head1 SYNOPSIS

cs-proteins-to-roles [arguments] < input > output
...
Usage: cs-proteins-to-roles [arguments] < input > output
...
our $usage = "usage: cs-proteins-to-roles [-c column] < input > output";
