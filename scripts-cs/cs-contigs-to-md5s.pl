...
cs-contigs-to-md5s [arguments] < input > output

=head1 DESCRIPTION


cs-contigs-to-md5s can be used to acquire MD5 values for each of a list of contigs.
...
Usage: cs-contigs-to-md5s [arguments] < input > output
...
our $usage = "usage: cs-contigs-to-md5s [-c column] < input > output";
