...
cs-proteins-to-fids [arguments] < input > output

=head1 DESCRIPTION


cs-proteins-to-fids takes as input a list of proteins (i.e., a list of md5s) and
...
Usage: proteins_to_fids [arguments] < input > output
...
our $usage = "usage: cs-proteins-to-fids [-c column] < input > output";
