...
cs-roles-to-complexes

=head1 SYNOPSIS

cs-roles-to-complexes [arguments] < input > output

=head1 DESCRIPTION


cs-roles-to-complexes allows a user to connect Roles to Complexes,
...
Usage: cs-roles-to-complexes [arguments] < input > output
...
our $usage = "usage: cs-roles-to-complexes [-c column] < input > output";
