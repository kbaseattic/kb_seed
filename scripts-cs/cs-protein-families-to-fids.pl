...
cs-protein-families-to-fids

=head1 SYNOPSIS

cs-protein-families-to-fids [arguments] < input > output

=head1 DESCRIPTION


cs-protein-families-to-fids can be used to access the set of fids represented by each of
...
Usage: protein_families_to_fids [arguments] < input > output
...
our $usage = "usage: cs-protein-families-to-fids [-c column] < input > output";
