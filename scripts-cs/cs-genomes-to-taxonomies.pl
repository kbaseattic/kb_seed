...
cs-genomes-to-taxonomies

=head1 SYNOPSIS

cs-genomes-to-taxonomies [arguments] < input > output

=head1 DESCRIPTION


The routine cs-genomes-to-taxonomies can be used to retrieve taxonomic information for
...
Usage: cs-genomes-to-taxonomies [arguments] < input > output
...
our $usage = "usage: cs-genomes-to-taxonomies [-c column] < input > output";
