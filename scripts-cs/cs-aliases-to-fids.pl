...
cs-aliases-to-fids [arguments] < input > output

=head1 DESCRIPTION


cs-aliases-to-fids is used to search for the feature ids that a set of given
aliases maps to.
...
Usage: cs-aliases-to-fids [arguments] < input > output
...
our $usage = "usage: cs-aliases-to-fids [-c column] < input > output";
