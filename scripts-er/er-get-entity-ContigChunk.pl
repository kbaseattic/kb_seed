...
er-get-entity-ContigChunk

=head1 SYNOPSIS

er-get-entity-ContigChunk [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-ContigChunk -a < ids > table.with.fields.added
...
Usage: er-get-entity-ContigChunk [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-ContigChunk: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
