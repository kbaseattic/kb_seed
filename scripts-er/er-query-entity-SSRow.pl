...
er-query-entity-SSRow

=head1 SYNOPSIS

er-query-entity-SSRow [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    er-query-entity-SSRow -is id,exact-match-value -a > records
...
er-query-entity-SSRow [arguments] > records
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-all-entities-SSRow: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
}
