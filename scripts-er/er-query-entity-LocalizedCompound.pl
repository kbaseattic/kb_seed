...
er-query-entity-LocalizedCompound

=head1 SYNOPSIS

er-query-entity-LocalizedCompound [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    er-query-entity-LocalizedCompound -is id,exact-match-value -a > records
...
er-query-entity-LocalizedCompound [arguments] > records
