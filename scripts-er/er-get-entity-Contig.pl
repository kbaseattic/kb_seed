...
er-get-entity-Contig

=head1 SYNOPSIS

er-get-entity-Contig [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Contig -a < ids > table.with.fields.added
...
Usage: er-get-entity-Contig [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Contig: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
