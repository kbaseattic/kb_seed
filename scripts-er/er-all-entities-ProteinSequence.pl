...
er-all-entities-ProteinSequence

=head1 SYNOPSIS

er-all-entities-ProteinSequence [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-ProteinSequence -a 
...
Usage: er-all-entities-ProteinSequence [arguments] > entity.data
