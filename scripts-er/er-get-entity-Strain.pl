...
er-get-entity-Strain

=head1 SYNOPSIS

er-get-entity-Strain [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Strain -a < ids > table.with.fields.added
...
Usage: er-get-entity-Strain [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Strain: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
