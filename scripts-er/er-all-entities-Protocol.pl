...
er-all-entities-Protocol

=head1 SYNOPSIS

er-all-entities-Protocol [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Protocol [arguments] > entity.data
