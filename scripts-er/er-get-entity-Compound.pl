...
er-get-entity-Compound

=head1 SYNOPSIS

er-get-entity-Compound [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Compound -a < ids > table.with.fields.added
...
Usage: er-get-entity-Compound [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Compound: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
