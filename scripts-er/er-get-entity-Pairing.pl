...
er-get-entity-Pairing

=head1 SYNOPSIS

er-get-entity-Pairing [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Pairing -a < ids > table.with.fields.added
...
Usage: er-get-entity-Pairing [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Pairing: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
