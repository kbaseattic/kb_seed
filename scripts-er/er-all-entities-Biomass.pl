...
er-all-entities-Biomass

=head1 SYNOPSIS

er-all-entities-Biomass [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Biomass [arguments] > entity.data
