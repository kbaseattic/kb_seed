...
er-get-entity-Alignment

=head1 SYNOPSIS

er-get-entity-Alignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Alignment -a < ids > table.with.fields.added
...
Usage: er-get-entity-Alignment [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Alignment: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
