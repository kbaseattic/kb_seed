...
er-all-entities-Pairing

=head1 SYNOPSIS

er-all-entities-Pairing [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Pairing [arguments] > entity.data
