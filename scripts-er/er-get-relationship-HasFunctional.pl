...
er-get-relationship-HasFunctional

=head1 SYNOPSIS

er-get-relationship-HasFunctional [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-HasFunctional -a < ids > table.with.fields.added
...
Usage: er-get-relationship-HasFunctional [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-HasFunctional [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-HasFunctional: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
