...
er-get-relationship-IsContainedIn

=head1 SYNOPSIS

er-get-relationship-IsContainedIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsContainedIn -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsContainedIn [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsContainedIn [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsContainedIn: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
