...
er-query-entity-Trait

=head1 SYNOPSIS

er-query-entity-Trait [--is field,value] [--like field,value] [--op operator,field,value]

=head1 DESCRIPTION

Query the entity Trait. Results are limited using one or more of the query flags:
...
Example:
    ...
    er-query-entity-Trait -is id,exact-match-value -a > records
...
er-query-entity-Trait [arguments] > records
