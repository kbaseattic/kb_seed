...
er-all-entities-Location

=head1 SYNOPSIS

er-all-entities-Location [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Location [arguments] > entity.data
