...
er-all-entities-AlleleFrequency

=head1 SYNOPSIS

er-all-entities-AlleleFrequency [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-AlleleFrequency -a 
...
Usage: er-all-entities-AlleleFrequency [arguments] > entity.data
