...
er-all-entities-MeasurementDescription

=head1 SYNOPSIS

er-all-entities-MeasurementDescription [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-MeasurementDescription -a 
...
Usage: er-all-entities-MeasurementDescription [arguments] > entity.data
