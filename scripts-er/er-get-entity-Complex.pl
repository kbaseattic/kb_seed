...
er-get-entity-Complex

=head1 SYNOPSIS

er-get-entity-Complex [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Complex -a < ids > table.with.fields.added
...
Usage: er-get-entity-Complex [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Complex: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
