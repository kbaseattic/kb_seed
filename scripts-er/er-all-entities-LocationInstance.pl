...
er-all-entities-LocationInstance

=head1 SYNOPSIS

er-all-entities-LocationInstance [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-LocationInstance -a 
...
Usage: er-all-entities-LocationInstance [arguments] > entity.data
