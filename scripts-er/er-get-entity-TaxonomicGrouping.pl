...
er-get-entity-TaxonomicGrouping

=head1 SYNOPSIS

er-get-entity-TaxonomicGrouping [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-TaxonomicGrouping -a < ids > table.with.fields.added
...
Usage: er-get-entity-TaxonomicGrouping [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-TaxonomicGrouping: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
