...
er-get-entity-CoregulatedSet

=head1 SYNOPSIS

er-get-entity-CoregulatedSet [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-CoregulatedSet -a < ids > table.with.fields.added
...
Usage: er-get-entity-CoregulatedSet [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-CoregulatedSet: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
