...
er-get-entity-Biomass

=head1 SYNOPSIS

er-get-entity-Biomass [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Biomass -a < ids > table.with.fields.added
...
Usage: er-get-entity-Biomass [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Biomass: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
