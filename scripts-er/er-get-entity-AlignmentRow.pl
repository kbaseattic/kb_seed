...
er-get-entity-AlignmentRow

=head1 SYNOPSIS

er-get-entity-AlignmentRow [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-AlignmentRow -a < ids > table.with.fields.added
...
Usage: er-get-entity-AlignmentRow [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-AlignmentRow: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
