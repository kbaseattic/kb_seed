...
er-get-entity-Publication

=head1 SYNOPSIS

er-get-entity-Publication [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Publication -a < ids > table.with.fields.added
...
Usage: er-get-entity-Publication [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Publication: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
