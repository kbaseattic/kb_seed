...
er-all-entities-Subsystem

=head1 SYNOPSIS

er-all-entities-Subsystem [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Subsystem [arguments] > entity.data
