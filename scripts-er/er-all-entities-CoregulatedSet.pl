...
er-all-entities-CoregulatedSet

=head1 SYNOPSIS

er-all-entities-CoregulatedSet [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-CoregulatedSet -a 
...
Usage: er-all-entities-CoregulatedSet [arguments] > entity.data
