...
er-all-entities-Annotation

=head1 SYNOPSIS

er-all-entities-Annotation [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Annotation [arguments] > entity.data
