...
er-get-relationship-HasPresenceOf

=head1 SYNOPSIS

er-get-relationship-HasPresenceOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-HasPresenceOf -a < ids > table.with.fields.added
...
Usage: er-get-relationship-HasPresenceOf [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-HasPresenceOf [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-HasPresenceOf: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
