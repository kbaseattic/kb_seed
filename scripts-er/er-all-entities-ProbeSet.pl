...
er-all-entities-ProbeSet

=head1 SYNOPSIS

er-all-entities-ProbeSet [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-ProbeSet [arguments] > entity.data
