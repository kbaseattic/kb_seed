...
er-all-entities-Environment

=head1 SYNOPSIS

er-all-entities-Environment [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Environment [arguments] > entity.data
