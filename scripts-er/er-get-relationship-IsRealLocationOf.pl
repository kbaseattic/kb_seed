...
er-get-relationship-IsRealLocationOf

=head1 SYNOPSIS

er-get-relationship-IsRealLocationOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsRealLocationOf -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsRealLocationOf [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsRealLocationOf [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsRealLocationOf: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
