...
er-get-relationship-IsFamilyFor

=head1 SYNOPSIS

er-get-relationship-IsFamilyFor [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsFamilyFor -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsFamilyFor [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsFamilyFor [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsFamilyFor: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
