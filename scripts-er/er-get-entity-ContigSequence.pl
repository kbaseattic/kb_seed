...
er-get-entity-ContigSequence

=head1 SYNOPSIS

er-get-entity-ContigSequence [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-ContigSequence -a < ids > table.with.fields.added
...
Usage: er-get-entity-ContigSequence [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-ContigSequence: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
