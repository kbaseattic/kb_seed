...
er-all-entities-ExperimentalUnit

=head1 SYNOPSIS

er-all-entities-ExperimentalUnit [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-ExperimentalUnit -a 
...
Usage: er-all-entities-ExperimentalUnit [arguments] > entity.data
