...
er-get-entity-Genome

=head1 SYNOPSIS

er-get-entity-Genome [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Genome -a < ids > table.with.fields.added
...
Usage: er-get-entity-Genome [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Genome: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
