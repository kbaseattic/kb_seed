...
er-all-entities-Alignment

=head1 SYNOPSIS

er-all-entities-Alignment [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Alignment [arguments] > entity.data
