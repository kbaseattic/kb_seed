...
er-all-entities-AtomicRegulon

=head1 SYNOPSIS

er-all-entities-AtomicRegulon [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-AtomicRegulon -a 
...
Usage: er-all-entities-AtomicRegulon [arguments] > entity.data
