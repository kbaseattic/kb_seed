...
er-all-entities-StudyExperiment

=head1 SYNOPSIS

er-all-entities-StudyExperiment [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-StudyExperiment -a 
...
Usage: er-all-entities-StudyExperiment [arguments] > entity.data
