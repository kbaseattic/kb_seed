...
er-query-entity-Biomass

=head1 SYNOPSIS

er-query-entity-Biomass [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    er-query-entity-Biomass -is id,exact-match-value -a > records
...
er-query-entity-Biomass [arguments] > records
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-all-entities-Biomass: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
}
