...
er-get-entity-Subsystem

=head1 SYNOPSIS

er-get-entity-Subsystem [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Subsystem -a < ids > table.with.fields.added
...
Usage: er-get-entity-Subsystem [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Subsystem: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
