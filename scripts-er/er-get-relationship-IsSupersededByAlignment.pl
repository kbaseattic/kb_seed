...
er-get-relationship-IsSupersededByAlignment

=head1 SYNOPSIS

er-get-relationship-IsSupersededByAlignment [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsSupersededByAlignment -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsSupersededByAlignment [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsSupersededByAlignment [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsSupersededByAlignment: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
