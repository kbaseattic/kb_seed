...
er-all-entities-Feature

=head1 SYNOPSIS

er-all-entities-Feature [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Feature [arguments] > entity.data
