...
er-get-entity-AtomicRegulon

=head1 SYNOPSIS

er-get-entity-AtomicRegulon [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-AtomicRegulon -a < ids > table.with.fields.added
...
Usage: er-get-entity-AtomicRegulon [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-AtomicRegulon: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
