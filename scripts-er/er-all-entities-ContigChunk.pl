...
er-all-entities-ContigChunk

=head1 SYNOPSIS

er-all-entities-ContigChunk [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-ContigChunk [arguments] > entity.data
