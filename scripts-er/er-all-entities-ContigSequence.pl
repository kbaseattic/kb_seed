...
er-all-entities-ContigSequence

=head1 SYNOPSIS

er-all-entities-ContigSequence [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-ContigSequence -a 
...
Usage: er-all-entities-ContigSequence [arguments] > entity.data
