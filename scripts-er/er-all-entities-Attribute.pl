...
er-all-entities-Attribute

=head1 SYNOPSIS

er-all-entities-Attribute [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Attribute [arguments] > entity.data
