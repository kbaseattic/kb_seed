...
er-all-entities-Publication

=head1 SYNOPSIS

er-all-entities-Publication [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Publication [arguments] > entity.data
