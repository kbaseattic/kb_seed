...
er-all-entities-Scenario

=head1 SYNOPSIS

er-all-entities-Scenario [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Scenario [arguments] > entity.data
