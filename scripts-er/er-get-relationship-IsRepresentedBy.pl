...
er-get-relationship-IsRepresentedBy

=head1 SYNOPSIS

er-get-relationship-IsRepresentedBy [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsRepresentedBy -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsRepresentedBy [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsRepresentedBy [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsRepresentedBy: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
