...
er-all-entities-ExperimentalUnitGroup

=head1 SYNOPSIS

er-all-entities-ExperimentalUnitGroup [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-ExperimentalUnitGroup -a 
...
Usage: er-all-entities-ExperimentalUnitGroup [arguments] > entity.data
