...
er-get-entity-Measurement

=head1 SYNOPSIS

er-get-entity-Measurement [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Measurement -a < ids > table.with.fields.added
...
Usage: er-get-entity-Measurement [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Measurement: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
