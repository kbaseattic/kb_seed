...
er-all-entities-CodonUsage

=head1 SYNOPSIS

er-all-entities-CodonUsage [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-CodonUsage [arguments] > entity.data
