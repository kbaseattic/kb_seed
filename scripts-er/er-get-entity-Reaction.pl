...
er-get-entity-Reaction

=head1 SYNOPSIS

er-get-entity-Reaction [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Reaction -a < ids > table.with.fields.added
...
Usage: er-get-entity-Reaction [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Reaction: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
