...
er-all-entities-Complex

=head1 SYNOPSIS

er-all-entities-Complex [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Complex [arguments] > entity.data
