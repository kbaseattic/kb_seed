...
er-all-entities-ExperimentMeta

=head1 SYNOPSIS

er-all-entities-ExperimentMeta [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-ExperimentMeta -a 
...
Usage: er-all-entities-ExperimentMeta [arguments] > entity.data
