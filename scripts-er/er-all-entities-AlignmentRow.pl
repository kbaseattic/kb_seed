...
er-all-entities-AlignmentRow

=head1 SYNOPSIS

er-all-entities-AlignmentRow [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-AlignmentRow -a 
...
Usage: er-all-entities-AlignmentRow [arguments] > entity.data
