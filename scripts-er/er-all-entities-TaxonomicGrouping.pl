...
er-all-entities-TaxonomicGrouping

=head1 SYNOPSIS

er-all-entities-TaxonomicGrouping [-a] [--fields fieldlist] > entity-data
...
Example:
    ...
    er-all-entities-TaxonomicGrouping -a 
...
Usage: er-all-entities-TaxonomicGrouping [arguments] > entity.data
