...
er-get-entity-Feature

=head1 SYNOPSIS

er-get-entity-Feature [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-entity-Feature -a < ids > table.with.fields.added
...
Usage: er-get-entity-Feature [arguments] < ids > table.with.fields.added
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-get-entity-Feature: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
} else {
    print STDERR $usage;
