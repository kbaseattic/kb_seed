...
er-all-entities-Locality

=head1 SYNOPSIS

er-all-entities-Locality [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Locality [arguments] > entity.data
