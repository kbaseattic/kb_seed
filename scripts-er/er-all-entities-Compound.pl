...
er-all-entities-Compound

=head1 SYNOPSIS

er-all-entities-Compound [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Compound [arguments] > entity.data
