...
er-get-relationship-Includes

=head1 SYNOPSIS

er-get-relationship-Includes [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-Includes -a < ids > table.with.fields.added
...
Usage: er-get-relationship-Includes [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-Includes [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-Includes: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
