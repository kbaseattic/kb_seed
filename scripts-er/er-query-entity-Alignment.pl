...
er-query-entity-Alignment

=head1 SYNOPSIS

er-query-entity-Alignment [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    er-query-entity-Alignment -is id,exact-match-value -a > records
...
er-query-entity-Alignment [arguments] > records
...
if ($a)
{
    ...
    if (@err)
    {
	print STDERR "er-all-entities-Alignment: unknown fields @err. Valid fields are: @all_fields\n";
	exit 1;
    }
}
