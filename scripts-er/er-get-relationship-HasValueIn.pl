...
er-get-relationship-HasValueIn

=head1 SYNOPSIS

er-get-relationship-HasValueIn [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-HasValueIn -a < ids > table.with.fields.added
...
Usage: er-get-relationship-HasValueIn [arguments] < ids > table.with.fields.added
...
Choose a set of fields from the Attribute
...
our $usage = <<'END';
Usage: get-relationship-HasValueIn [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-HasValueIn: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
