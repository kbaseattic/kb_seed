...
er-query-entity-Person

=head1 SYNOPSIS

er-query-entity-Person [--is field,value] [--like field,value] [--op operator,field,value]
...
Example:
    ...
    er-query-entity-Person -is id,exact-match-value -a > records
...
er-query-entity-Person [arguments] > records
