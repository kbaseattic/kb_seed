...
er-all-entities-Diagram

=head1 SYNOPSIS

er-all-entities-Diagram [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Diagram [arguments] > entity.data
