...
er-get-relationship-IsComponentOf

=head1 SYNOPSIS

er-get-relationship-IsComponentOf [-c N] [-a] [--fields field-list] < ids > table.with.fields.added
...
Example:
    ...
    er-get-relationship-IsComponentOf -a < ids > table.with.fields.added
...
Usage: er-get-relationship-IsComponentOf [arguments] < ids > table.with.fields.added
...
our $usage = <<'END';
Usage: get-relationship-IsComponentOf [arguments] < ids > table.with.fields.added
...
sub check_fields {
	...
	if (@err) {
		...
		print STDERR "er-get-relationship-IsComponentOf: unknown fields @err. Valid fields are @f\n";
		return 1;
	}
	return 0;
}
