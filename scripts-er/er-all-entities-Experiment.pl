...
er-all-entities-Experiment

=head1 SYNOPSIS

er-all-entities-Experiment [-a] [--fields fieldlist] > entity-data
...
Usage: er-all-entities-Experiment [arguments] > entity.data
